/* Archivo: src/pages/MujerPage.jsx */

import React from "react";
// Importa SOLO los componentes que esta página renderiza directamente
import BannerMujer from "../components/banners/BannerMujer"; // Importa el banner específico
...
// NO importes Chatbot.jsx ni Navbar.css aquí. 
// El Layout se encarga del Navbar y el Chatbot.

export default function MujerPage() { // Renombrado a MujerPage para consistencia
  return (
    // No necesitas la clase "App" aquí usualmente, App.jsx es el contenedor principal
    <div> 
      <BannerMujer /> {/* Renderiza el banner específico */}
      
      {/* El 'main' es opcional, depende de tu Layout */}
      <main style={{ padding: "40px 20px" }}> 
        
        {/* PASA EL PROP 'categoria' a cada componente de catálogo */}
        <Novedades categoria="mujer" /> 
        <Tendencias categoria="mujer" />
        <Rebajas categoria="mujer" />
...
>
  ...
  <div className="footer-section" style={{ marginBottom: "40px" }}>
    ...
    >
      Explora la colección de ropa para mujer y encuentra vestidos para cada ocasión,
      blusas en distintos materiales y tops con cortes que se adaptan a tu estilo.
      Descubre también pantalones y jeans en diferentes calces, polos lisos o estampados
      y zapatos perfectos para completar tus looks de temporada. Complementa tu outfit
      con accesorios que aportan un toque especial.
    </p>
  </div>
