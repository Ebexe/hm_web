/* Archivo: src/pages/NinasPage.jsx */

import React from "react";
// Importa el banner específico para niñas (asegúrate de que exista)
...
export default function NinasPage() { 
  return (
    <div> 
      <BannerNinos /> {/* Renderiza el banner específico de niñas */}
      
      <main style={{ padding: "40px 20px" }}> 
        
        {/* PASA EL PROP 'categoria="nina"' */}
        <Novedades categoria="nina" /> 
        <Tendencias categoria="nina" />
        <Rebajas categoria="nina" />
