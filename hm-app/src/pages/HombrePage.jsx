/* Archivo: src/pages/HombrePage.jsx */

import React from "react";
// Importa el banner específico para hombre
import BannerHombre from "../components/banners/BannerHombre"; 
...
export default function HombrePage() { 
  return (
    <div> 
      <BannerHombre /> {/* Renderiza el banner específico de hombre */}
      
      <main style={{ padding: "40px 20px" }}> 
        
        {/* PASA EL PROP 'categoria="hombre"' */}
        <Novedades categoria="hombre" /> 
        <Tendencias categoria="hombre" />
        <Rebajas categoria="hombre" />
...
>
  ...
  <div className="footer-section" style={{ marginBottom: "40px" }}>
    ...
    >
      Nuestra colección para hombre ofrece ropa, calzado y accesorios pensados para cada ocasión. 
      Desde polos, jeans y poleras para un estilo casual, hasta camisas, pantalones y blazers ideales 
      para un look formal. Completa tu outfit con zapatos y accesorios que marcan la diferencia. 
      Además, descubre nuestra sección de ropa deportiva, con prendas cómodas y modernas para tu día a día. 
      Encuentra todo lo que necesitas para tus looks de temporada.
    </p>
  </div>
